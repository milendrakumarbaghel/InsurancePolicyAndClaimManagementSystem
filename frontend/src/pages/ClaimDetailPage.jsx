                ...
                {documents.map((doc) => (
                  <div key={doc.claimDocumentId} className="flex items-center justify-between rounded-lg border border-ink-100 dark:border-ink-800 px-3.5 py-2.5">
                    <div className="flex items-center gap-3 min-w-0">
                      <FileText className="h-4 w-4 text-harbor-500 shrink-0" />
                    ...
                    {role === ROLES.CUSTOMER && (
                      <button onClick={() => handleDeleteDocument(doc.claimDocumentId)} className="text-ink-400 hover:text-danger transition-colors shrink-0">
